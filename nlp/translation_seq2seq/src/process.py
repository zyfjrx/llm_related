...
def process():
    ...
    train_df.to_json(config.PROCESSED_DATA_DIR / 'train_zh.json',orient='records',lines=True)
    ...
    test_df.to_json(config.PROCESSED_DATA_DIR / 'test_zh.json', orient='records', lines=True)
