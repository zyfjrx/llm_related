...
class VLMConfig(PretrainedConfig):
    ...
    def __init__(self, llm_model_path='/home/bmh/project/model/Qwen/Qwen2.5-0.5B-Instruct',
                 vision_model_path='/home/bmh/project/model/siglip-so400m-patch14-384',
...
class VLM(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.linear1 = nn.Linear(self.vision_model.config.vision_config.hidden_size * 9,
    ...
    def forward(self, input_ids, labels, pixel_values, attention_mask=None):
        ...
        image_embeds = image_embeds.view(b, -1, d * 9)  # (b, 792, d) --> (b, 81, d*9) 压缩图片tokens
...
if __name__ == '__main__':
    config = VLMConfig(vision_model_path='/home/bmh/project/model/siglip-so400m-patch14-384', image_pad_num=81)
    model = VLM(config).cuda()
    print(model)
    print(f'模型参数量为：{sum(p.numel() for p in model.parameters() if p.requires_grad)}')
    images_path = '/home/bmh/project/dataset/pre_data/vlm'
    data_path = '/home/bmh/project/dataset/pre_data/vlm/chat-translated.json'
