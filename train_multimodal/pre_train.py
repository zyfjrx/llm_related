...
class MyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            answer = conversations[1]['value']+self.tokenizer.eos_token
            q_input_ids = self.tokenizer(question)['input_ids']
            a_input_ids = self.tokenizer(answer)['input_ids']
            ...
            answer = '图片内容为空' + self.tokenizer.eos_token
            q_input_ids = self.tokenizer(question)['input_ids']
            a_input_ids = self.tokenizer(answer)['input_ids']
            input_ids = q_input_ids + a_input_ids
            labels = [self.tokenizer.pad_token_id]*len(q_input_ids)+a_input_ids
