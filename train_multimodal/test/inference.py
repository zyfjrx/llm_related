...
model = AutoModelForCausalLM.from_pretrained('/Users/zhangyf/PycharmProjects/train/llm_related/train_multimodal/test/checkpoint-2500')
model.to(device)
...
image = Image.open('/Users/zhangyf/Documents/WechatIMG443.jpg').convert("RGB")
